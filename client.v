	...
	for i in 0 .. 10 {
		for j in 0 .. 10 {
			color := match app.map[i][j] {
				...
				11, 12, 13, 14, 15, 16, 17, 18 { gg.Color{0, 255, 0, 255} }
				21, 22, 23, 24, 25, 26, 27, 28 { gg.Color{255, 144, 33, 255} }
				31, 32, 33, 34, 35, 36, 37, 38 { gg.Color{255, 15, 43, 255} }
				41, 42, 43, 44, 45, 46, 47, 48 { gg.Color{255, 150, 215, 255} }
				51, 52, 53, 54, 55, 56, 57, 58 { gg.Color{102, 255, 204, 255} }
				61, 62, 63, 64, 65, 66, 67, 68 { gg.Color{51, 163, 255, 255} }
